...
<body style="font-family: Arial, sans-serif; line-height: 1.6; margin: 20px;">
    ...
    <p>Hello! I'm Shyam Sankar M, passionate on Coding enthusiast from Coimbatore, India. A Software Engineering graduate with hands-on experience in real-time application design, development, Testing through collaborative team projects. Eager to apply my technical skills and creativity to develop innovative and impactful software solutions.Currently, I'm pursuing my B.E. in Computer Science at Dr. NGP Institute of Technology with a 76 % grade . My journey into the world of technology started early and has been enriched by my academic endeavors and hands-on experiences in the field of Front End dev.</p>
    
  <h2 style="color: #333;">🎓 Education</h2>
    <ul>
        <li><strong>B.E. in Computer Science</strong> | DR.N.G.P. Institute of Technology (2021 - 2025)</li>
